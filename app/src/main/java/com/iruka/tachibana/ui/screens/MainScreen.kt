...
fun MainScreen(
    ...
    val nextGoalDays = goalDaysList.firstOrNull { it > elapsedDays } ?: ((elapsedDays / 30 + 1) * 30)
    ...
    val remainingMinutesToGoal = (TimeUnit.MILLISECONDS.toMinutes(remainingMillisToGoal) % 60).toInt()
...
///tipsmodal　　切り替えアニメーション
        ...
        Column(
            ...
            // 🏁 ユーザー目標タイトル
            Row {
                Text("あなたの", fontSize = 12.sp, color = Color(0xFF555555), fontFamily = yuseiFont)
            ...
            Row(verticalAlignment = Alignment.Bottom) {
                Text("$elapsedDays", fontSize = 24.sp, color = Color(0xFFF29C9C), fontFamily = yuseiFont)
                Text("日", fontSize = 14.sp, color = Color(0xFFD99494), fontFamily = yuseiFont, modifier = Modifier.alpha(alpha))
                Text("$elapsedHours", fontSize = 24.sp, color = Color(0xFFF29C9C), fontFamily = yuseiFont)
                Text("時間", fontSize = 14.sp, color = Color(0xFFD99494), fontFamily = yuseiFont, modifier = Modifier.alpha(alpha))
                Text("$elapsedMinutes", fontSize = 24.sp, color = Color(0xFFF29C9C), fontFamily = yuseiFont)
                Text("分", fontSize = 14.sp, color = Color(0xFFD99494), fontFamily = yuseiFont, modifier = Modifier.alpha(alpha))
            }
            ...
            Row(verticalAlignment = Alignment.Bottom) {
                Text("$daysToNextGoal", fontSize = 24.sp, color = Color(0xFFF29C9C), fontFamily = yuseiFont)
                Text("日", fontSize = 14.sp, color = Color(0xFFD99494), fontFamily = yuseiFont, modifier = Modifier.alpha(alpha))
                Text("$remainingHoursToGoal", fontSize = 24.sp, color = Color(0xFFF29C9C), fontFamily = yuseiFont)
                Text("時間", fontSize = 14.sp, color = Color(0xFFD99494), fontFamily = yuseiFont, modifier = Modifier.alpha(alpha))
                Text("$remainingMinutesToGoal", fontSize = 24.sp, color = Color(0xFFF29C9C), fontFamily = yuseiFont)
                Text("分", fontSize = 14.sp, color = Color(0xFFD99494), fontFamily = yuseiFont, modifier = Modifier.alpha(alpha))
            }
            ...
            Text("${savedAmount}円", fontSize = 24.sp, fontFamily = yuseiFont, color = Color(0xFF7A5E45))
            Spacer(modifier = Modifier.height(8.dp))
            Row {
                ...
                Text("カロリー", fontSize = 16.sp, color = Color(0xFF555555),fontFamily = yuseiFont)
            }
            Spacer(modifier = Modifier.height(8.dp))
            Text("${savedCalories}Kcal", fontSize = 24.sp, fontFamily = yuseiFont, color = Color(0xFF7A5E45))
...
///リセットボタン！！！！！
    ...
    when (activeModal) {
        ...
        ModalType.Tips -> TipsModal(
            onClose = ::closeModal,
            setComment = { /* no-op */ }
        )

        ModalType.Post -> PostModal(onClose = ::closeModal)
        ModalType.Menu -> MenuModal(onClose = ::closeModal)
        ModalType.Calendar -> CalendarModal(onClose = ::closeModal)
